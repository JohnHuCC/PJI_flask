...
def run_test(PID, top_num, singleton_num):
    ...
    # print('')
    rules_list = auto_pick_boundary_v1.find_delta(
    ...
    with open("Tree_Candidate/Tree_candidate_new_data_"+str(PID)+"_final_tree", "wb") as Tree_candidate_file:
    ...
    with open('final_result/final_result_v1_top'+str(top)+'_tree.txt', 'a') as f:
...
if __name__ == "__main__":
    ...
    for i, top in enumerate(top_num_high):
        ...
        with open('final_result/test_out_v1_tree.txt', 'a') as f:
            f.write('Top:')
            f.write(str(top))
            # f.write('\n')
