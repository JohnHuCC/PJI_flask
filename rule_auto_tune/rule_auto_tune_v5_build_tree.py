...
def getTopN_Fidelity(fidelity_list, top_N_indices, top_N, PID):
    ...
    with open('final_result/decision_tree_v5_top'+str(top)+'_tree.txt', 'a') as f:
...
def run_test(PID, top_num, singleton_num):
    ...
    with open("Tree_Candidate/Tree_candidate_new_data_"+str(PID)+"_final_tree_v5_"+str(top_num), "wb") as Tree_candidate_file:
    ...
    with open('final_result/final_result_v5_top'+str(top)+'_tree.txt', 'a') as f:
...
if __name__ == "__main__":
    rule_problem = [3971, 6101, 7331, 7451, 4562, 7332]
    ...
    for i, top in enumerate(top_num_high):
        ...
        with open('final_result/test_out_v5_tree.txt', 'a') as f:
            f.write('Top:')
            f.write(str(top))
            f.write('\n')
