...
import time
import auto_pick_boundary_v3_2
...
def run_test(PID, top_num, singleton_num):
    ...
    # print('')
    rules_list = auto_pick_boundary_v3_2.find_delta(
    ...
    with open('final_result/final_result_v3_top'+str(top)+'_no_tree.txt', 'a') as f:
...
if __name__ == "__main__":
    ...
    for i, top in enumerate(top_num_high):
        ...
        with open('final_result/test_out_v3_no_tree.txt', 'a') as f:
            f.write('Top:')
            f.write(str(top))
            # f.write('\n')
