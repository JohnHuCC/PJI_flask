...
def run_test(PID, top_num):
    ...
    with open('final_result/final_result_v2_top'+str(top)+'.txt', 'a') as f:
...
if __name__ == "__main__":
    rule_problem = [4562, 6182, 7332]
    rule_ok = [1311, 151, 8201, 23012, 23752, 42, 331, 531, 541, 581, 631, 671, 1101, 1121, 1291, 1311,
               1331, 1721, 1861, 2351, 2441, 2951, 3211, 3621, 3671, 4111, 4621, 5221, 5291, 5391, 5541,
               1312, 1882, 1912, 2102, 2502, 2892, 5082, 6012, 6142]
    ...
    for top in top_num_high:
        ...
        with open('final_result/test_out_v2.txt', 'a') as f:
            f.write('Top:')
            f.write(str(top))
            f.write('\n')
