...
# X_train.to_csv('internal_X_for_new_data.csv', encoding='utf-8', index=False)
# y_train.to_csv('internal_y_for_new_data.csv', encoding='utf-8', index=False)
...
PID = [1311, 151, 8201, 23012, 23752, 42, 331, 531, 541, 581, 631, 671, 1101, 1121, 1291, 1311,
...
for i in PID:
    internal_x_test = pd.read_csv('internal_x_test.csv', encoding='utf-8')
    no_group_all = list(internal_x_test['No.Group'])
    PID_index_all = no_group_all.index(i)
