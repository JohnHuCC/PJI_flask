...
def simplified_singleton_opt(PID, final_singleton):
    ...
    print('True Class:', str(personal_result))
    print('')
    res_combined = []
    rules_list_ = []
    decision_list = {}
...
def find_delta(rules_list, PID):
    ...
    #         if key not in singleton_dict_less_than:
    #             singleton_dict_less_than.setdefault(
    #                 key, set()).add(str(condition))
    #         else:
    #             singleton_dict_less_than[key].add(str(condition))
    ...
    #     elif condition.find(">=") > 0:
    #         key = condition[:condition.find(">=")-1]
    #         if key not in singleton_dict_more_than:
    #             singleton_dict_more_than.setdefault(
    #                 key, set()).add(str(condition))
    #         else:
    #             singleton_dict_more_than[key].add(str(condition))
    #     elif condition.find(">") > 0:
    #         key = condition[:condition.find(">")-1]
    #         if key not in singleton_dict_more_than:
    #             singleton_dict_more_than.setdefault(
